...
@Composable
fun LocationServiceAlertDialog(onConfirm: () -> Unit, onDismissRequest: () -> Unit) {
    AppDialog(
        dialogModel = DialogModel(
            content = {
                LocationServiceAlertContent(
                    onConfirm = onConfirm,
...
@Composable
fun LocationServiceAlertContent(
    ...
    Column(
        ...
        AppText(
            ...
            text = R.string.Location_alert_title_dialog,
            textType = TextType.SubTitle
        )
        AppText(
            text = R.string.location_alert_dialog,
